...
const Pricing = () => {
  ...
  <div className="py-6 px-4 mx-auto max-w-screen-xl lg:py-6 lg:px-6">
      <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="mb-4 text-4xl tracking-tight  text-gray-900 dark:text-white font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-950">Our Pricing Plans</h2>
          <p className="mb-5 font-normal text-gray-500 sm:text-xl dark:text-gray-400">Here at Project Studio we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
