        ...
        <button type="button" className="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-left p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 hover:bg-gray-700 active" id="tabs-with-card-item-1" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
          <span className="flex">
            ...
            <span className="grow ml-6">
              ...
              <span className="block mt-1 text-gray-200 dark:hs-tab-active:text-gray-200 dark:text-gray-200">Unlock your projects full potential with advanced management toolsstreamlining tasks, boosting productivity, and ensuring success at every step. Elevate your projects to new heights .</span>
            </span>
          </span>
        </button>
      ...
      <div className="relative">
        ...
        <div>
          <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
            <img className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.2]" src="https://res.cloudinary.com/dawzncoau/image/upload/v1699279431/7007591_wgwp20.jpg" alt="Image Description"/>
          </div>
