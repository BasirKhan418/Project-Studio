...
"/bg6.mp4"
    ...
    <div className="res grid max-w-screen-xl px-4 py-6 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 absolute top-32 left-32 ">
        ...
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link href="/login" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Get started
