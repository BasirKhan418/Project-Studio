  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <input type="text" placeholder='Enter Your Room Id' className='mx-2 border-2 border-blue-600 rounded p-2 font-semibold' name='roomid' value={roomidinput} onChange={handleChange}/>
            <button  onClick ={joinRoom} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-600 border border-blue-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Join Now
            </button> 
        </div>
