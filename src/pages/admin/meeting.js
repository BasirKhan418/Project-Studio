...
//join meeting code
const Join=()=>{
  router.push(`/admin/Joinmeet?roomid=${roomidinput}&&name=${userinfo.name.replace(" ","_")}`);
}

//Create Meeting and Join Meeting
const CreateJoin=()=>{
  const room = Math.floor(Math.floor(Math.random() * 100000));
setRoomidinput(room);

router.push(`/admin/Joinmeet?roomid=${room}&&name=${userinfo.name.replace(" ","_")}`);
}
  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <button onClick={CreateJoin} className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 ">
            ...
            <button  onClick ={Join} className="my-0 inline-flex items-center justify-center px-5 py-3 mr-5 text-base font-medium text-center text-white bg-blue-600 border border-blue-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Join Now
            </button> 
        </div>
